...
public class PD194UnpStrategy extends AbsDeviceUnpackStrategy<PD194Convert, PD194Packet> {
    private Map<Integer, Method> methods_07;
    private Map<Integer, Method> methods_0A;
    ...
    private PD194Convert fetchOrInitDeviceConvert() {
    ...
    @Override
    protected PD194Packet handleActive(int size, Map<Integer, ResultWrapper> ycData, Map<Integer, ResultWrapper> yxData, Map<Integer, ResultWrapper> ymData) {
        PD194Packet packet = fetchOrInitDeviceConvert().getOriginal();
